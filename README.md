...
Inicia os workspaces em modo de desenvolvimento

npm run dev:api

Inicia apenas a API com recarregamento automático

npm run build

Compila os workspaces disponíveis
...
Executa os testes configurados nos workspaces
